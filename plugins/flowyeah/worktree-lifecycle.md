...
4. Run each command in `worktree.setup` sequentially, with the env vars exported. If any setup command fails, **STOP** and report — do not proceed with broken dependencies.
